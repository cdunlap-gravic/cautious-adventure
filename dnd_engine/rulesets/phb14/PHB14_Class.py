    ...
    def __init__(self):
        super().__init__(
            ...
            levelFeatures={
                ...
                4: [classFeature.ASI],
                5: [classFeature.BARDIC_INSPIRATION, "Font of Inspiration"],
                6: ["Countercharm", classFeature.SUBCLASS_FEATURE],
                7: [],
                8: [classFeature.ASI],
                9: ["Song of Rest"],
                10: [classFeature.BARDIC_INSPIRATION, classFeature.EXPERTISE, "Magical Secrets"],
                11: [],
                12: [classFeature.ASI],
                13: ["Song of Rest"],
    ...
    def __init__(self):
        super().__init__(
            ...
            levelFeatures={
                ...
                2: ["Wild Shape", classFeature.SUBCLASS_CHOICE],
                3: [],
...
class Fighter(Class):
    def __init__(self):
        super().__init__(
            ...
            levelFeatures={
                1: [classFeature.FIGHTING_STYLE, "Second Wind"],
                2: ["Action Surge"],
                3: [classFeature.SUBCLASS_CHOICE],
    ...
    def __init__(self):
        super().__init__(
            ...
            levelFeatures={
                ...
                3: ["Deflect Missiles", classFeature.SUBCLASS_CHOICE],
                4: [classFeature.ASI, "Slow Fall"],
                5: [classFeature.EXTRA_ATTACK, "Stunning Strike"], #? Is this the same Extra Attack as Barbarian?
    ...
    def __init__(self):
        super().__init__(
            ...
            levelFeatures={
                ...
                2: ["Divine Smite", classFeature.FIGHTING_STYLE, classFeature.SPELLCASTING],
                3: ["Divine Health", classFeature.SUBCLASS_CHOICE],
                4: [classFeature.ASI],
                5: [classFeature.EXTRA_ATTACK],
...
class Rogue(Class):
    def __init__(self):
        super().__init__(
            ...
            levelFeatures={
                1: [classFeature.EXPERTISE, "Sneak Attack", "Thieves' Cant"],
                2: ["Cunning Action"],
                3: [classFeature.SUBCLASS_CHOICE],
                4: [classFeature.ASI],
                5: ["Uncanny Dodge"],
